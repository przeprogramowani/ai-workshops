...
2. Zakres testów
3. Typy testów do przeprowadzenia (np. testy jednostkowe, integracyjne, wydajnościowe) wraz z doprecyzowaniem obszarów testowych
...
Przygotowany plan testów zapisz w folderze ./docs/test-plan.md
